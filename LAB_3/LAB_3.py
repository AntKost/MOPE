...
class Lab3:
    def __init__(self):
        ...
        self.x3_min = -40
        self.x3_max = -20
        self.x_average_min = (self.x1_min + self.x2_min + self.x3_min)/3
        self.x_average_max = round((self.x1_max + self.x2_max + self.x3_max)/3)
    ...
    def generate_matrix(self):
        ...
        print(
            "Дані варіанту 212 : y_max = {}  y_min = {}  x1_min = {}  x1_max = {}  x2_min = {}  x2_max = {}  x3_min = {}  x3_max = {}".format(
