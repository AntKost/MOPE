...
class Lab2:
    ...
    def matrix23(self):
        ...
        print(
            "Дані варіанту 212 : Y_max = {}  Y_min = {}  X1_min = {}  X1_max = {}  X2_min = {}  X2_max = {}".format(
    ...
    def print(self):
        print("Остаточні дані варіанту 212 після перевірок : Y_max = {}  Y_min = {}  X1_min = {}  X1_max = {}  X2_min = {}  X2_max = {}".format(
            self.Y_max, self.Y_min, self.X1_min, self.X1_max, self.X2_min, self.X2_max))
        print("Матриця планування для m = {}".format(self.N))
        print("-" * 13)
        for i in range(3):
