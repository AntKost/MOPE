...
def create_plan_matrix(n, m):
    ...
    print("y = 5,4+2,4*x1+7,3*x2+9,6*x3+2,5*x1*x1+0,2*x2*x2+8,2*x3*x3+1,7*x1*x2+0,7*x1*x3+0,6*x2*x3+9,3*x1*x2*x3 + random(10) - 5")
    print('Y :')
    pprint.pprint(y)
...
def count_y(x_arr):
    return 5.4 + 2.4 * x_arr[1] + 7.3 * x_arr[2] + 9.6 * x_arr[3] + 2.5 * x_arr[8] + 0.2 * x_arr[9] + 8.2 * x_arr[10] + 1.7 * x_arr[4] + 0.7 * x_arr[5] + 0.6 * x_arr[6] + 9.3 * x_arr[7] + r.randint(0, 10) -5
